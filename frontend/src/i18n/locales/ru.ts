  ...
  translation: {
    ...
    domainDescription: {
      ...
      [Domains['Data Engineering']]:
        'Создание и поддержка конвейеров данных, ETL-процессов и инфраструктуры данных',
      [Domains['Fullstack Development']]:
        'Разработка клиентской и серверной частей приложений',
      [Domains.Teaching]:
        'Обучение и наставничество в IT, создание образовательного контента и проведение тренингов',
    },
