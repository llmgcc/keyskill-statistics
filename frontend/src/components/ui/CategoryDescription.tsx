...
export function CategoryDescription({categoryKey, categoryName} : CategoryDescriptionProps) {
    ...
    <div className="flex items-center">
        ...
        <div className="text-sm font-[600] capitalize">
          ...
          <div className="flex items-center text-[0.8em] leading-3 text-text-secondary font-[500]">Some text about category</div>
        </div>
      </div>
    )
}