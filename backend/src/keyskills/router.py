...
from src.keyskills.service import skills_list
from src.keyskills.schemas import KeySkillsResponse
...
async def get_skills(
    ...
    return await skills_list(
        ...
        category=category,
        domain=domain,
        domainStrict=domainStrict,
        categoryStrict=categoryStrict,
